...
import { MainComponents } from '@/configs/docs';
                ...
                <>
                  <li key={`id-${index}`}>
                    <Link
                      ...
                      className={`flex gap-2 group font-medium items-center py-1  transition-all ${link.href === pathname
                        ? 'active-nav'
      ...
      <ul className='relative'>
        {items.map((link: any, index: number) => (
          <li
            ...
            className={`2xl:text-sm text-[0.81em]  flex items-center gap-1 dark:hover:text-white 2xl:py-1 py-0.5 pl-2 border-l transition-all ${link.href === pathname
