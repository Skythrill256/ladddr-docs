        ...
        <div className='mx-auto flex items-center justify-between gap-2 px-2 2xl:container'>
          <Link href='/' className='hidden lg:block'>
            <div className='relative hidden gap-2 lg:flex'>
              ...
              <p className="--font-selector:R0Y7SUJNIFBsZXggTW9uby02MDA=;--framer-font-family:&quot;IBM Plex Mono&quot;, monospace;--framer-font-size:36px;--framer-font-weight:600;--framer-text-color:rgb(30, 30, 30)" >Ladddr</p>
            </div>
          </Link>
